          ...
          <div className="flex gap-2 overflow-auto pt-2">
            ...
            {combinedChatFiles.map((file, index) =>
              file.id === 'loading' ? (
                <div
                  key={index}
                  className="relative flex h-[64px] items-center space-x-4 rounded-xl border px-4 py-3"
                >
                ...
                <div
                  key={file.id}
                  className="relative flex h-[64px] cursor-pointer items-center space-x-4 rounded-xl border px-4 py-3 hover:opacity-50"
